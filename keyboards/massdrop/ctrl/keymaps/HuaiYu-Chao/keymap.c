...
enum function_ctrl_keycode {
    EXT_CTL = MD_BOOT + 1,  // Extended Ctrl Key
    EXT_ESC,  // Extended Esc Key
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        EXT_CTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MO(2),   KC_APP,  KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [1] = LAYOUT(
        ...
        _______, KC_LGUI, KC_LALT,                   KC_CAPS,                            KC_RALT, XXXXXXX, KC_RGUI, KC_RCTL,            _______, _______, _______ \
    ),
    [2] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,            KC_MUTE, XXXXXXX, XXXXXXX, \
        ...
        XXXXXXX, RGB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, MD_BOOT, NK_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                              XXXXXXX, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    static uint32_t fun_ctl_timer = 201;

    switch (keycode) {
        case EXT_CTL:
            if (record->event.pressed) {
                if (timer_elapsed32(fun_ctl_timer) > 300) {
                    layer_on(1);
                    fun_ctl_timer = timer_read32();
                } else {
                    layer_on(1);
